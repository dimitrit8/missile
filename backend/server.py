...
async def initialize_database():
    ...
    # Force refresh all data with accurate researched information
    await db.conflicts.delete_many({})
    await db.strikes.delete_many({})
    ...
    # Insert sample strikes data with launch and target locations
    strikes_data = [
        # Russia-Ukraine strikes - with launch locations
        {"id": "ru-ua-001", "conflict_id": "russia-ukraine", "date": "2022-02-24", "location": "Kyiv", "country": "Ukraine", "latitude": 50.4501, "longitude": 30.5234, "missile_type": "Kalibr", "missile_cost": 2000000, "launch_location": "Black Sea Fleet", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 25, "deceased": 8, "description": "Strike on military facility"},
        {"id": "ru-ua-002", "conflict_id": "russia-ukraine", "date": "2022-03-15", "location": "Kharkiv", "country": "Ukraine", "latitude": 49.9935, "longitude": 36.2304, "missile_type": "Iskander-M", "missile_cost": 2400000, "launch_location": "Belgorod Oblast, Russia", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 42, "deceased": 15, "description": "Residential area strike"},
        {"id": "ru-ua-003", "conflict_id": "russia-ukraine", "date": "2023-05-10", "location": "Dnipro", "country": "Ukraine", "latitude": 48.4647, "longitude": 35.0462, "missile_type": "Kinzhal", "missile_cost": 4500000, "launch_location": "MiG-31K from Engels Air Base", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Dnipro Oblast", "casualties": 0, "deceased": 0, "description": "First confirmed Kinzhal interception by Patriot"},
        {"id": "ru-ua-004", "conflict_id": "russia-ukraine", "date": "2024-01-20", "location": "Odesa", "country": "Ukraine", "latitude": 46.4825, "longitude": 30.7233, "missile_type": "Kh-101", "missile_cost": 2500000, "launch_location": "Tu-95MS from Engels Air Base", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Odesa Oblast airspace", "casualties": 0, "deceased": 0, "description": "Port infrastructure target - intercepted"},
        {"id": "ru-ua-005", "conflict_id": "russia-ukraine", "date": "2024-11-18", "location": "Lviv", "country": "Ukraine", "latitude": 49.8397, "longitude": 24.0297, "missile_type": "Shahed-136", "missile_cost": 50000, "launch_location": "Kursk Oblast, Russia", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Western Ukraine", "casualties": 0, "deceased": 0, "description": "Drone swarm attack - 12 of 15 intercepted"},
        {"id": "ru-ua-006", "conflict_id": "russia-ukraine", "date": "2025-02-10", "location": "Zaporizhzhia", "country": "Ukraine", "latitude": 47.8388, "longitude": 35.1396, "missile_type": "Iskander-M", "missile_cost": 2400000, "launch_location": "Crimea", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 18, "deceased": 6, "description": "Energy infrastructure strike"},
        {"id": "ru-ua-007", "conflict_id": "russia-ukraine", "date": "2025-08-05", "location": "Mariupol", "country": "Ukraine", "latitude": 47.0971, "longitude": 37.5432, "missile_type": "Kalibr", "missile_cost": 2000000, "launch_location": "Black Sea Fleet submarine", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 65, "deceased": 22, "description": "Civilian building strike"},
        {"id": "ru-ua-008", "conflict_id": "russia-ukraine", "date": "2026-01-12", "location": "Poltava", "country": "Ukraine", "latitude": 49.5883, "longitude": 34.5514, "missile_type": "Kh-101", "missile_cost": 2500000, "launch_location": "Tu-160 from Ukrainka Air Base", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Poltava Oblast", "casualties": 0, "deceased": 0, "description": "Intercepted cruise missile"},
        {"id": "ru-ua-009", "conflict_id": "russia-ukraine", "date": "2026-02-28", "location": "Sumy", "country": "Ukraine", "latitude": 50.9077, "longitude": 34.7981, "missile_type": "Shahed-136", "missile_cost": 50000, "launch_location": "Bryansk Oblast, Russia", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 8, "deceased": 3, "description": "Drone strike on infrastructure"},
        {"id": "ru-ua-010", "conflict_id": "russia-ukraine", "date": "2026-03-15", "location": "Chernihiv", "country": "Ukraine", "latitude": 51.4982, "longitude": 31.2893, "missile_type": "Iskander-M", "missile_cost": 2400000, "launch_location": "Belarus border", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Chernihiv Oblast", "casualties": 0, "deceased": 0, "description": "Military base target - intercepted"},
        
        # Israel-Hamas strikes - with launch locations
        {"id": "il-ha-001", "conflict_id": "israel-hamas", "date": "2023-10-07", "location": "Sderot", "country": "Israel", "latitude": 31.5240, "longitude": 34.5964, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Northern Gaza Strip", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 12, "deceased": 5, "description": "October 7th attack - rocket barrage"},
        {"id": "il-ha-002", "conflict_id": "israel-hamas", "date": "2023-10-08", "location": "Ashkelon", "country": "Israel", "latitude": 31.6688, "longitude": 34.5742, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Central Gaza", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Ashkelon airspace", "casualties": 0, "deceased": 0, "description": "Intercepted rocket barrage - 45 rockets"},
        {"id": "il-ha-003", "conflict_id": "israel-hamas", "date": "2023-11-20", "location": "Tel Aviv", "country": "Israel", "latitude": 32.0853, "longitude": 34.7818, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Gaza City", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Central Israel airspace", "casualties": 0, "deceased": 0, "description": "Rocket intercepted over city"},
        {"id": "il-ha-004", "conflict_id": "israel-hamas", "date": "2024-01-15", "location": "Beersheba", "country": "Israel", "latitude": 31.2530, "longitude": 34.7915, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Khan Yunis, Gaza", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Negev airspace", "casualties": 0, "deceased": 0, "description": "Mass rocket attack - 78 rockets launched"},
        {"id": "il-ha-005", "conflict_id": "israel-hamas", "date": "2024-05-22", "location": "Netivot", "country": "Israel", "latitude": 31.4190, "longitude": 34.5958, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Rafah, Gaza", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 6, "deceased": 2, "description": "Residential area hit"},
        {"id": "il-ha-006", "conflict_id": "israel-hamas", "date": "2024-09-10", "location": "Kiryat Gat", "country": "Israel", "latitude": 31.6100, "longitude": 34.7642, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Central Gaza", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Kiryat Gat vicinity", "casualties": 0, "deceased": 0, "description": "Intercepted barrage - 23 rockets"},
        {"id": "il-ha-007", "conflict_id": "israel-hamas", "date": "2025-03-18", "location": "Ashdod", "country": "Israel", "latitude": 31.8044, "longitude": 34.6553, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Gaza Strip", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Ashdod port area", "casualties": 0, "deceased": 0, "description": "Port city defense - 15 rockets intercepted"},
        {"id": "il-ha-008", "conflict_id": "israel-hamas", "date": "2025-07-05", "location": "Ofakim", "country": "Israel", "latitude": 31.3181, "longitude": 34.6197, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Southern Gaza", "intercepted": False, "interceptor_type": None, "interceptor_cost": None, "casualties": 3, "deceased": 1, "description": "Direct hit on residential building"},
        {"id": "il-ha-009", "conflict_id": "israel-hamas", "date": "2025-11-28", "location": "Dimona", "country": "Israel", "latitude": 31.0698, "longitude": 35.0330, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Gaza Strip", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Dimona airspace", "casualties": 0, "deceased": 0, "description": "Strategic facility protected"},
        {"id": "il-ha-010", "conflict_id": "israel-hamas", "date": "2026-02-14", "location": "Sderot", "country": "Israel", "latitude": 31.5240, "longitude": 34.5964, "missile_type": "Qassam-3", "missile_cost": 500, "launch_location": "Northern Gaza", "intercepted": True, "interceptor_type": "Iron Dome Tamir", "interceptor_cost": 50000, "interception_location": "Sderot vicinity", "casualties": 0, "deceased": 0, "description": "Successful Iron Dome defense"},
        
        # Iran-Israel strikes - with launch and interception locations
        {"id": "ir-il-001", "conflict_id": "iran-israel", "date": "2024-04-13", "location": "Tel Aviv", "country": "Israel", "latitude": 32.0853, "longitude": 34.7818, "missile_type": "Fateh-110", "missile_cost": 150000, "launch_location": "Western Iran", "intercepted": True, "interceptor_type": "Arrow 3", "interceptor_cost": 4000000, "interception_location": "Exo-atmospheric over Jordan", "casualties": 0, "deceased": 0, "description": "April 2024 Iranian attack - 99% interception rate"},
        {"id": "ir-il-002", "conflict_id": "iran-israel", "date": "2024-10-01", "location": "Haifa", "country": "Israel", "latitude": 32.7940, "longitude": 34.9896, "missile_type": "Fateh-110", "missile_cost": 150000, "launch_location": "Tabriz, Iran", "intercepted": True, "interceptor_type": "Patriot PAC-3 MSE", "interceptor_cost": 4000000, "interception_location": "Northern Israel airspace", "casualties": 0, "deceased": 0, "description": "October 2024 attack - naval port targeted"},
